		...
		<div v-show="modal" class="font-general-regular fixed inset-0 z-30">
			...
			>
				<transition name="fade-up-down">
					...
					>
						<div
							class="modal max-w-md mx-5 md:max-w-xl bg-secondary-light dark:bg-primary-dark max-h-screen shadow-lg flex-row rounded-lg relative" style="min-width: 33rem;"
						>
							<div
